...
```{r read file}
OR_table <-read.table("./PpyrOR_Scaffolds_FINAL_2025_01_15.gff.txt", sep ="\t")
...
only_totals$suffix <-  factor(only_totals$suffix, levels = c("", "NTE", "PSE", "NC"), labels = c("Full length", "Partial", "PSE", "Partial"))
```
